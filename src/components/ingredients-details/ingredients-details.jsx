...
export default function IngredientsDetails() {
  ...
  return (
    <>
      ...
      <h3 className={`${styles.name} text text_type_main-medium p-0 mt-4 mb-8`}>
        {name}
      </h3>
      <ul className={styles.values}>
        <li className={styles.value}>
          <p
            className={`${styles.component} m-0 p-0 text text_type_main-default text_color_inactive`}
          >
            Калории,ккал
          </p>
          <p
            className={`${styles.count} p-0 m-0 text text_type_digits-default text_color_inactive`}
          >
            {calories}
          </p>
        </li>
