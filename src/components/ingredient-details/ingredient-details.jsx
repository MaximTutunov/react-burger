    ...
    return (
      ...
      <ul className={styles.values}>
        <li className={styles.value}>
          ...
          <p className={`${styles.counter} p-0 m-0 text text_type_digits-default text_color_inactive`}>{props.calories}</p>
        </li>
        <li className={styles.value}>
          <p className={`${styles.component} m-0 p-0 text text_type_main-default text_color_inactive`}>Белки, г</p>
          <p className={`${styles.counter} p-0 m-0 text text_type_digits-default text_color_inactive`}>{props.proteins}</p>
        </li>
        <li className={styles.value}>
          <p className={`${styles.component} m-0 p-0 text text_type_main-default text_color_inactive`}>Жиры, г</p>
          <p className={`${styles.counter} p-0 m-0 text text_type_digits-default text_color_inactive`}>{props.fat}</p>
        </li>
        <li className={styles.value}>
          <p className={`${styles.component} m-0 p-0 text text_type_main-default text_color_inactive`}>Углеводы, г</p>
          <p className={`${styles.counter} p-0 m-0 text text_type_digits-default text_color_inactive`}>{props.carbohydrates}</p>
        </li>
      </ul>
    </>
    )
