...
export const BurgerIngredients: FC = () => {
  ...
  return (
    <section className={`${style.section} mt-10 pl-5`}>
      <h1 className={`${style.title} text text_type_main-large mb-5`}>
        Соберите бургер
      </h1>
      ...
      <ul className={`${style.ingredients} pt-5`}>
        <Ingredients ingredients={ingredients} type="bun" tabRef={bunRef} />
        <Ingredients ingredients={ingredients} type="sauce" tabRef={sauceRef} />
        <Ingredients ingredients={ingredients} type="main" tabRef={mainRef} />
      </ul>
    </section>
  );
};
